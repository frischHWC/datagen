...
public class OzoneUtils {
  ...
  OzoneUtils(Model model,
    ...
    this.replicationConfig = null; // ReplicationConfig.parse(ReplicationType.RATIS, String.valueOf(replicationFactor), config);
  ...
  protected void pushKeyToOzone(String localPath, String keyName) {
    try {
      ...
      OzoneOutputStream os = bucket.createKey(keyName, dataToWrite.length,
          ReplicationType.RATIS, replicationFactor, Collections.emptyMap());
