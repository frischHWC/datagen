...
public class Utils {
    ...
    public static String getPropertyFromXMLFile(String filePath, String property) {
        ...
        try {
            ...
            log.warn("Could not inspect file: {} to find property: {} - returning empty value", filePath, property);
            log.debug("Error: ", e);
        }
    ...
    public static String getSolrZKQuorumFromEnvsh(String filePath) {
        ...
        try {
            ...
            log.warn("Could not inspect file: {} to find solr info - returning empty value", filePath);
            log.debug("Error: ", e);
        }
    ...
    public static List<String> getAllPropertiesKeyFromPropertiesFile(String filePath, String property) {
        ...
        try {
            ...
            log.warn("Could not inspect file: {} to find info - returning empty value", filePath);
            log.warn("Error: ", e);
        }

        log.debug("Return value: {} from file: {}", values.stream().reduce((x, y) -> x+ "," + y), filePath);
        return values;
    }

    public static String getOnePropertyValueFromPropertiesFile(String filePath, String property) {
        String value = "";
        try {
            BufferedReader reader;
            reader = new BufferedReader(new FileReader(filePath));
