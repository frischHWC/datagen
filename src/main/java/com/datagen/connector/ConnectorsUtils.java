 ...
 */
package com.datagen.connector;

import com.datagen.config.ApplicationConfigs;
import com.datagen.config.ConnectorParser;
import com.datagen.connector.db.hbase.HbaseConnector;
import com.datagen.connector.db.hive.HiveConnector;
import com.datagen.connector.index.SolRConnector;
import com.datagen.connector.queues.KafkaConnector;
import com.datagen.connector.storage.adls.*;
import com.datagen.connector.storage.files.*;
import com.datagen.connector.storage.gcs.*;
import com.datagen.connector.storage.hdfs.*;
import com.datagen.connector.storage.kudu.KuduConnector;
import com.datagen.connector.storage.ozone.*;
import com.datagen.connector.storage.s3.*;
