...
import com.datagen.service.model.ModelTesterSevice;
...
public class ModelTesterController {
  ...
  public String testModel(
    ...
    log.debug("Received request to test model: {} ,", modelName);
    return modelTesterSevice.generateData(modelFile, modelName);
  }
}
